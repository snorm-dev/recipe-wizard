...
type Querier interface {
	...
	GetItem(ctx context.Context, id int64) (IngredientInstance, error)
	GetItemsForGroceryList(ctx context.Context, groceryListID int64) ([]IngredientInstance, error)
	GetItemsForRecipeInstance(ctx context.Context, recipeInstanceID sql.NullInt64) ([]IngredientInstance, error)
